...
3. If your problem hasn't been previously reported, you can post a question on the [Exercism Support Forum][exercism-support-forum]. There is a good chance that somebody will respond.
4. Based on the response you got on the forum, you may decide to post a new [issue][github-odin-issues].
If you do, follow the format below.
...
(This is really important, if we can't reproduce your problem, we can't fix it.)
- What environment are you running
  ...
  Running `odin report` will generate information on the OS, CPU, and Odin version.
...
They have been subject to a lot of scrutiny even if there is always room for improvement.

If you have a general issue with the exercise, the best approach is to take it with the Exercism community, through the [Exercism Support Forum][exercism-support-forum] first and then possibly by opening an issue against the [Exercism Problem Specification Repo][github-exercism-problem-specification-issues].
...
What we can do is add Odin specific supplemental documentation (to the instructions or the introduction), as well as add discussions on the recommended approaches or articles on specific algorithms.
...
Finally the list of concepts associated with the Odin track includes a more substantial introduction and a set of references and are discussed in the [Exercism doc for Concepts][exercism-concept-doc]. The [Concept Map for the Odin Track][odin-concept-map] provides more detail on what we plan to provide for the Odin track.
...
2. If there is no existing issue, you can then post on the [Exercism Support Forum][exercism-support-forum].
...
- Read [The Odin Developer FAQS][odin-developer-faqs]
...
[odin-developer-faqs]: https://github.com/exercism/odin/blob/main/dev/docs/FAQS.md
